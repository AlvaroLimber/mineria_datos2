...
texto <- "Esto es un tezto con algunos errores de ortografia en las palabras."
hunspell(texto,dict =  "es_ES")
hunspell_suggest(texto,dict =  "es_ES")
```
